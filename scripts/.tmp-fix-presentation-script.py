...
# Fix the editor loop precondition to match the current implementation.
...
# Align common-language test patches with the current PR #8 wording.
...
common_patch = """# Common-language catalog capabilities
