...
const CATPPUCCIN_OVERRIDES = mudSemanticOverrides({
  ...
  "top-level-declaration-modifier": ["#8839ef", "#cba6f7"],
  "control-flow": ["#d20f39", "#f38ba8"],
  "quantifier-keyword": ["#d20f39", "#f38ba8"],
...
const VSCODE_OVERRIDES = mergeOverrides(
  mudSemanticOverrides({
    ...
    "top-level-declaration-modifier": ["#0000ff", "#569cd6"],
    "control-flow": ["#af00db", "#c586c0"],
    "quantifier-keyword": ["#af00db", "#c586c0"],
...
const SOLARIZED_OVERRIDES = mudSemanticOverrides({
  ...
  "top-level-declaration-modifier": ["#268bd2", "#268bd2"],
  "control-flow": ["#dc322f", "#dc322f"],
  "quantifier-keyword": ["#dc322f", "#dc322f"],
...
const GITHUB_OVERRIDES = mudSemanticOverrides({
  ...
  "top-level-declaration-modifier": ["#8250df", "#d2a8ff"],
  "control-flow": ["#cf222e", "#ff7b72"],
  "quantifier-keyword": ["#cf222e", "#ff7b72"],
...
const GRUVBOX_OVERRIDES = mudSemanticOverrides({
  ...
  "top-level-declaration-modifier": ["#076678", "#83a598"],
  "control-flow": ["#9d0006", "#fb4934"],
  "quantifier-keyword": ["#9d0006", "#fb4934"],
