  ...
  private async importDocument(expected: "settings" | "language" | "theme"): Promise<void> {
    ...
    try {
      ...
      if (documentValue.kind === "syntax-highlight-settings") {
        ...
        const imported = structuredClone(documentValue.language.profile);
        imported.embeddedLexicalGrammar = documentValue.language.grammars.lexical;
        imported.embeddedSyntaxGrammar = documentValue.language.grammars.syntax;
